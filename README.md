...
<p>Objetivo del proyecto: Revisar cinco bases de datos: crecimiento económico PIB, crecimiento PPA, crecimiento poblacional, índice de precios al consumidor y tasa de desempleo para conocer la posición de México frente a otras economías importantes en la región de América Latina.</p>
<p>Paquetería utilizada: Anaconda, VS Code, Python, pandas y plotly</p>
<p>Habilidades adquiridas: Análisis de datos, limpieza de datos, visualización de datos, condicionales y filtros</p>
...
<img width="1266" height="450" alt="pibpc" src="https://github.com/user-attachments/assets/957fdbf1-a286-48d2-bf90-138c8d58f638" />
<h3>Observaciones: El PIB per capita es el valor total de bienes y servicios producidos por un país dividido entre su población.</h3>
<ul>
  <li><strong>México y Brasil</strong> crecieron un 29% y 28.8% respectivamente lo que los mantiene con trayectorias ascendentes que los hacen atractivos para inversión y comercio.</li>
  <li><strong>Argentina</strong> muestra el mayor crecimiento porcentual, pero está distorsionado por la inflación y la devaluación del peso Argentino.</li>
  <li><strong>Chile</strong> lidera en PIB per capita, posicionándolo como economía de alto valor agregado y mayor poder adquisitivo promedio.</li>
  <li><strong>Colombia</strong> mejora un poco, pero aún tiene desafíos estructurales para elevar su ingreso promedio.</li>
</ul>
<img width="1266" height="450" alt="pibrrg" src="https://github.com/user-attachments/assets/e2b61a17-08d4-4810-9ce5-3ccc315bbbf0" />
<h3>Observaciones: La tasa real de crecimiento del PIB refleja el cambio porcentual en la producción de bienes y servicios, ajustado por inflación.</h3>
<ul>
  <li><strong>Argentina y Chile</strong> muestran rebotes fuertes en 2021, pero con señales de desaceleración en 2022, lo que sugiere fragilidad estructural o dependencia de factores externos.</li>
  <li><strong>México</strong> mantiene una recuperación moderada, lo que refleja estabilidad macroeconómica, pero también desafíos estructurales para acelerar el crecimiento.</li>
  <li><strong>Brasil</strong> muestra resiliencia con crecimiento moderado pero consistente.</li>
